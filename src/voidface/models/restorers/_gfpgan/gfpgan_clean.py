...
#   * ARCH_REGISTRY sourced from _basicsr_shims to break the basicsr
#     -> facexlib -> numba dependency chain.
#   * StyleGAN2GeneratorClean re-import path updated to the local
#     vendored file (stylegan2_clean rather than stylegan2_clean_arch).
#   * No functional changes to the architecture. State dicts from the
#     upstream v1.4 release load bit-for-bit.

"""Vendored GFPGANv1Clean architecture from GFPGAN."""
